...
Hardened by [Chainguard](https://www.chainguard.dev) from the upstream action at [https://github.com/mikepenz/release-changelog-builder-action](https://github.com/mikepenz/release-changelog-builder-action).

## Versions

| Version | Tag | Upstream commit |
|---------|-----|-----------------|
| v6.2.0 | [`v6.2.0`](https://github.com/chainguard-actions/mikepenz-release-changelog-builder-action/tree/v6.2.0) | [`2cb9bef`](https://github.com/mikepenz/release-changelog-builder-action/commit/2cb9befdbc05f65b8354cc9873cd506509bd0782) |
